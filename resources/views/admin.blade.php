                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading">Interface</div>
                          <!-- Catalog Section -->
                                ...
                                <div class="collapse" id="collapseUserStatus" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="{{ route('admin.reject-user') }}">Reject Users</a>
                                        <a class="nav-link" href="{{ route('admin.approved-users') }}">Approved Users</a> <!-- Fixed spelling: Approval -> Approved -->
                                    </nav>
                                </div>
